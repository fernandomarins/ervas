...
class TratamentoViewController: UIViewController {
    ...
    func setInfo(padrao: String) {
        ...
        case "Vazio de Qi":
            sinais.text = "Diminuição da atividade fisiológica do Zang-Fu. Vertigens, ofuscação das vistas, respiração curta embaraçando a conversa, esgotamento físico e mental, transpiração espontânea. Sintomas são agravados pelo esforço."
            exemplo.text = "A senilidade, desregramento alimentar, as doenças graves de longa duração que vão exaurindo o Qi da pessoa. A desarmonia é causada por insuficiência de Qi -> Yang Qi (Energia Original, do R e BP): diminuição da atividade fisiológica normal (falta Qi para gerar movimento, vitalidade), astenia (falta Qi para gerar movimento, vitalidade). Wei Qi (Energia de Defesa, P): Os poros cutâneos não se podem fechar (não há Qi para gerar contração e fechamento), daí há transpiração espontânea, respiração curta que embaraça a conversa (Zhong Qi não está sendo formado). Yong Qi (Energia de Nutrição, BP e P): A língua pálida (falta Qi para impulsionar o Xue até a língua), o pulso vazio, sem força (o Qi não movimenta bem o Xue, nem tonifica os vasos)”."
            tratamento.text = "Tonificar o Qi, utilizando “Ervas Tônicas do Qi”."
        default:
            return
        }
    }
