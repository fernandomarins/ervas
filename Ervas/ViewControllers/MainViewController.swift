...
//            let doesCategoryMatch = (erva.locaisAcao == scope) || (erva.nome == scope)
//
//            if isSearchBarEmpty() {
//                return doesCategoryMatch
//            } else {
//                // Returning the doesCategoryMatch AND the properties OR the órgão
//                return doesCategoryMatch || erva.locaisAcao.lowercased().contains(search.lowercased())
//            }
//        })
...
//        filteredContentForSearchText(search: searchBar.text!)
//    }
//}
